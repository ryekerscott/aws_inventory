...
import (
	...
	"gopkg.in/yaml.v3"
	"repo.com/path/inventory/acmutil"
	"repo.com/path/inventory/apiutil"
	"repo.com/path/inventory/cloudwatchutil"
	dynamodbutil "repo.com/path/inventory/dyanmodbutil"
	"repo.com/path/inventory/ec2util"
	"repo.com/path/inventory/efsutil"
	"repo.com/path/inventory/eksutil"
	"repo.com/path/inventory/emrutil"
	"repo.com/path/inventory/iamutil"
	"repo.com/path/inventory/lambdautil"
	"repo.com/path/inventory/osutil"
	"repo.com/path/inventory/rdsutil"
	"repo.com/path/inventory/route53util"
	"repo.com/path/inventory/s3util"
	"repo.com/path/inventory/snsutil"
	"repo.com/path/inventory/sqsutil"
	"repo.com/path/inventory/types"
	"repo.com/path/inventory/wsutil"
)
